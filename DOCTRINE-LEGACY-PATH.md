# Satoshi's Council — Legacy Doctrine (ARCHIVED)

> **This document is archived and no longer governs the system.**
> It describes the retired short-horizon Kalshi path-P&L / dual-sided scalp doctrine
> (version 2026-08-16). It is kept because it contains implementation detail — sizing
> functions, `locked_call` API contract, path-book semantics — that is still referenced
> by existing backend code.
>
> The active doctrine is `DOCTRINE.md`. See `PIVOT.md` for why this changed.
