...
/** One open door. WICK leads; TAPE is second; the rest are planned and say so. */
export function TrainingHome() {
  ...
  const planned = TRAINING_COACHES.filter((coach) => !coach.available);
  return <>
