...
const QA: { q: string; a: string }[] = [
  {
    q: "What is a seat?",
    a: "One specialist with one job. WICK reads candles, TAPE reads the Kalshi book, CARRY reads funding, CLOCK reads the session, and so on. Twenty of them sit at five desks. Each says UP, DOWN or WAIT with a confidence and shows its hypothesis, evidence and counter.",
  },
  {
