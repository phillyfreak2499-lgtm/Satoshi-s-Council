...
function About() {
  return (
    <Page title="How the desk works" lede="A paper-only Bitcoin research desk. Every 15 minutes, twenty-one specialist seats read the market, SATOSHI chairs the vote, and the result is graded in public.">
      ...
      <P>
        The live floor grades 15-minute windows. A separate <a href="/hour" className="text-fg underline underline-offset-2">hourly book</a> uses the same settlement family and keeps its own record.
      </P>
