...
function Home() {
  ...
  const { frame, last, books, fill } = Route.useLoaderData();
  return <InitialDeskFrame.Provider value={frame}>{legacyRoom ? <DeskApp last={last} /> : <CouncilHome last={last} books={books} fill={fill} />}</InitialDeskFrame.Provider>;
}
