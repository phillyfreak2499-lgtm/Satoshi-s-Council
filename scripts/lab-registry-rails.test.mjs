...
test("whole-Lab registry has one unique lifecycle row for every audited research path", () => {
  ...
  for (const id of [
    "chair-v2", "chair-v3", "taker-v1", "forced-v4", "openai-shadow-v1", "astra-director", "policy-exit",
...
test("registry server is aggregate read-only and has no actuator path", () => {
  ...
  for (const table of [
    ...
    "desk_openai_shadow", "desk_astra_director", "desk_policy_fills", "desk_replay", "desk_call_quality", "desk_absorption",
