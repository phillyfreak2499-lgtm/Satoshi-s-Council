...
// The brand-asset doc-sync tests that lived here were retired with the grok-pwa
// `.grok/skills/og` SKILL.md and AGENTS.md they pinned: this fork ships neither
// file, so they only ever ENOENT'd. The brand-check script itself stays covered
// by the CLI and computeBrandWarnings tests above (it is live — browser-smoke.mjs
// imports computeBrandWarnings to flag an oversized or missing OG card).
