...
// The "og skill hand-over" doc-sync test was retired with the grok-pwa
// `.grok/skills/og` references it read: this fork ships no such skill, so it
// only ever ENOENT'd. write-atomic.mjs itself stays covered by the arg-parse,
// staging-guard and CLI hand-over tests above and below.
