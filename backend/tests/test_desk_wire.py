...
class WireLogTests(unittest.TestCase):
    ...
    def test_seed_facts(self):
        ...
        self.assertIn("Four signed table rooms", blob)
        self.assertIn("Signed plates on Table with fade", blob)
        self.assertIn("Satoshi shrine", blob)
        self.assertIn("Raijin Dallas", blob)
        self.assertIn("Phone 390", blob)
        self.assertIn("No gold", blob)
        self.assertIn("Not Floor", blob)
        self.assertIn("Oracle later", blob)
