...
class WireLogTests(unittest.TestCase):
    ...
    def test_seed_facts(self):
        ...
        self.assertIn("2026-08-15-raijin-signed-crop", blob)
        self.assertIn("Cowboy WAIT is the signed square-crop", blob)
        self.assertIn("not the 1024 generate", blob)
        self.assertIn("UP/DOWN tint that same face", blob)
