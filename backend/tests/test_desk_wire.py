...
class WireLogTests(unittest.TestCase):
    def test_comment_and_shape(self):
        ...
        self.assertIn("signed /vitalik-wait.jpg", rows[0]["why"])
        self.assertIn("signed /raijin-wait.jpg", rows[0]["why"])
    ...
    def test_seed_facts(self):
        ...
        self.assertIn("ETH and Front chairs use the signed rain stills", blob)
