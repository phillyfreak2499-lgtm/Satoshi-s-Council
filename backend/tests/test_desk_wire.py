...
class WireLogTests(unittest.TestCase):
    def test_comment_and_shape(self):
        ...
        self.assertEqual(rows[0]["id"], "2026-08-16-coinglass-wall-tight")
        self.assertIn("plan wall", rows[0]["why"])
        self.assertIn("Startup+", rows[0]["why"])
        self.assertIn("CARRY", rows[0]["why"])
