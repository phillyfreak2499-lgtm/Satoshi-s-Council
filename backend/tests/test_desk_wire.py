...
class WireLogTests(unittest.TestCase):
    def test_comment_and_shape(self):
        ...
        self.assertIn("ETH chair scorecard", rows[0]["why"])
        self.assertIn("0–5", rows[0]["why"])
        self.assertIn("eth_shadow", rows[0]["why"])
        self.assertIn("BTC 5–3 stays", rows[0]["why"])
        self.assertIn("Bot memory", rows[0]["why"])
        self.assertIn("paper-locks the winner", rows[0]["why"])
        self.assertIn("Hunter still feeds 1–3", rows[0]["why"])
        self.assertIn("/oracle-wait.jpg", rows[0]["why"])
        self.assertIn("laurel", rows[0]["why"])
        self.assertIn("split-light man", rows[0]["why"])
        self.assertIn("/oracle-room.jpg stays the table back", rows[0]["why"])
        self.assertIn("No glowing-eye canvas swaps", rows[0]["why"])
