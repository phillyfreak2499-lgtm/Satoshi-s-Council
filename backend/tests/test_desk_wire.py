...
class WireLogTests(unittest.TestCase):
    def test_comment_and_shape(self):
        ...
        self.assertIn("/chair-wait.jpg", rows[0]["why"])
        self.assertIn("/vitalik-wait.jpg", rows[0]["why"])
        self.assertIn("/raijin-wait.jpg", rows[0]["why"])
        self.assertIn("/static/ares-wait.png", rows[0]["why"])
        self.assertIn("/oracle-wait.jpg", rows[0]["why"])
        self.assertIn("no cowboy hat", rows[0]["why"])
        self.assertIn("cache-busted", rows[0]["why"])
