...
class WireLogTests(unittest.TestCase):
    def test_comment_and_shape(self):
        ...
        self.assertIn("/static/bots/raijin-chair.png", rows[0]["why"])
        self.assertIn("home-screen cowboys", rows[0]["why"])
        self.assertIn("Not /raijin-wait.jpg", rows[0]["why"])
        self.assertIn("Dallas storm stays the table back", rows[0]["why"])
