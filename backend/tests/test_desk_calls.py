...
class PunchyCallCopyTests(unittest.TestCase):
    ...
    def test_wire_note(self):
        ...
        self.assertIn("Follower OFF", WIRE_JS.split("2026-08-16-one-face", 1)[1][:500])
        self.assertNotIn("ZT", WIRE_JS.split("2026-08-16-one-face", 1)[1].split("2026-08-16-hour-ladder", 1)[0])
