...
class DeskHtmlTests(unittest.TestCase):
    def test_summon_not_disabled_and_hit_rate_admin_only(self) -> None:
        ...
        self.assertIn("sw.js?v=20260821i", html)
        self.assertIn("roundtable.js?v=20260821i", html)
        self.assertIn("desk-fx.js?v=20260821i", html)
    ...
    def test_gate_is_an_oath_not_a_password(self) -> None:
        ...
        self.assertNotIn("campus-tab.js", html)
        ...
        self.assertIn("/hive-egg.webp", html)
        self.assertNotIn("/hive-egg.png", html)
        self.assertIn('id="summonVideo"', html)
        self.assertIn('id="leaderClickVideo"', html)
        self.assertNotIn('id="summonVideo" playsinline webkit-playsinline preload="metadata"', html)
        self.assertNotIn('id="leaderClickVideo" playsinline webkit-playsinline preload="metadata"', html)
        self.assertIn("/login-council.webp", html)
        self.assertNotIn("/login-council.jpg", html)
        self.assertIn("/static/ares-wait.webp", html)
        self.assertIn("/static/bots/raijin-chair.webp", html)
        self.assertIn("/static/bots/ice.webp", ROUNDTABLE)
        self.assertNotIn("/static/bots/ice.png", ROUNDTABLE)
        self.assertTrue((ROOT / "frontend" / "static" / "bots" / "ice.webp").is_file())
        self.assertTrue((ROOT / "frontend" / "static" / "hive-egg.webp").is_file())
        self.assertNotIn("/campus-tab.js", SW)
