...
class FrontMarkupTests(unittest.TestCase):
    def test_tab_and_ring_not_city_list(self):
        ...
        self.assertNotIn('"mark": "/static/bots/raijin-chair.png"', FRONT)
    ...
    def test_bot_marks_are_pngs_no_letter_fallback(self):
        ...
        self.assertIn("/raijin-wait.jpg", FRONT)
        self.assertNotIn('"/static/bots/raijin-wait.png"', FRONT)
...
class FrontWeatherTests(unittest.TestCase):
    ...
    def test_chair_face_is_storm_cowboy_not_empty_or_neon(self):
        ...
        self.assertIn('href="/raijin-wait.jpg?v=', HTML)
        self.assertIn('id="frontChairImg" src="/raijin-wait.jpg?v=', HTML)
...
class FrontBoardTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_dallas_only_named_seats(self):
        ...
        self.assertTrue(board["chair"]["portrait"].endswith("raijin-wait.jpg"))
    ...
    def test_chair_eyes_up_down_wait(self):
        ...
        self.assertTrue(wait["mark"].endswith("raijin-wait.jpg"))
        self.assertTrue(wait["portrait"].endswith("raijin-wait.jpg"))
        up = desk_front.build_chair({"dont_play": False, "bracket": "103–104"})
        self.assertEqual(up["eye"], "UP")
        self.assertTrue(up["mark"].endswith("raijin-wait.jpg"))
