...
class FrontMarkupTests(unittest.TestCase):
    def test_tab_and_ring_not_city_list(self):
        ...
        self.assertIn('"mark": "/static/bots/raijin-chair.png"', FRONT)
...
class FrontWeatherTests(unittest.TestCase):
    ...
    def test_chair_face_is_storm_cowboy_not_empty_or_neon(self):
        ...
        self.assertIn('href="/static/bots/raijin-chair.png?v=', HTML)
        self.assertIn('id="frontChairImg" src="/static/bots/raijin-chair.png?v=', HTML)
    ...
    def test_raijin_eyes_swap_like_vitalik(self):
        ...
        self.assertIn("/static/bots/raijin-chair.png", JS)
...
class FrontBoardTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_chair_eyes_up_down_wait(self):
        ...
        self.assertTrue(wait["mark"].endswith("raijin-chair.png"))
        ...
        self.assertTrue(up["mark"].endswith("raijin-chair.png"))
