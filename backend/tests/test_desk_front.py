...
class FrontMarkupTests(unittest.TestCase):
    def test_tab_city_cards_and_four_seats(self):
        ...
        self.assertIn("WEATHER CHAIR", HTML)
        self.assertIn("Same weight as Satoshi / Vitalik", HTML)
        self.assertIn("front-raijin-slot", HTML)
        self.assertIn("front-thunder-mark", HTML)
        self.assertNotIn("raijin-chair.png", HTML)
        self.assertNotIn("raijin-up.png", HTML + JS)
        self.assertNotIn("raijin-down.png", HTML + JS)
        self.assertNotIn("raijin-wait.png", HTML + JS)
    ...
    def test_settings_tutorial_no_zt(self):
        ...
        self.assertIn("same weight as Satoshi / Vitalik", JS)
    ...
    def test_css_routes_and_isolation(self):
        ...
        self.assertIn("front-raijin", CSS)
        self.assertIn("front-thunder-mark", CSS)
...
class FrontBoardTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_required_cities_vote_and_best(self):
        ...
        self.assertIsNone(board["chair"]["portrait"])
        self.assertIsNone(board["chair"]["mark"])
        self.assertEqual(board["chair"]["slot"], "/static/bots/raijin.png")
        card = board["cards"][0]
