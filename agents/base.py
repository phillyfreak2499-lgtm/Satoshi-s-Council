...
GOAL_CONTRACT_SHORT = "GOAL · process over prediction · WAIT unless confluence"
...
ETH_GOAL_CONTRACT_SHORT = "GOAL · one high-quality read, or WAIT"
...
PATH_SCALP_MARK = "read only · not a final call"
