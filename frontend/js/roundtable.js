/**
 * Satoshi’s Council – Longer-Horizon Research Desk
 * Table Mode: cyberpunk Round Table of specialist agents
 * Dashboard Mode: armor-plate neon HUD cards
 * Paper-first · Confluence required · Process over prediction
 */
(() => {
