...
const PRECACHE = [
  ...
  "/static/layout-cleanup.css?v=" + VERSION,
  "/static/focus-table.js?v=" + VERSION,
  "/static/watch-loop.js?v=" + VERSION,
  "/static/watch-loop.css?v=" + VERSION,
