...
window.COUNCIL_WIRE = [
  {
    ...
    "why": "Zach Voice: Satoshi was sitting too much on KXBTC15M (WAIT on the 3:30 ET book around 2:17pm CT). Drop the lock bar a notch for Satoshi / the BTC 15m Chair only — more explore paper locks when EV is still ≥ 0 and the book is real. Keep the 10–90¢ band. Keep the 99¢ / stale / empty-book veto. Hard maxes still beat Kelly. Do not clamp_min a negative-edge add. Do not loosen ETH 1H (Vitalik), Ares, or Oracle. Same PR: replay settled official Kalshi 15m BTC books (KXBTC15M / official result only), merge into the Satoshi seat brain the same way the 90-day 1h replay did — merge not wipe, tag backfill, do not write the displayed Chair hit slate / scorecard from replay. Paginate and checkpoint so the box does not melt. CoinGlass hist stays off this book (plan wall / wrong timeframe). Path-P&L scoring stays; ETH stays 1H one-lock. Product name stays Satoshi’s Council. Paper. Follower OFF."
  },
  {
